...
axes[0].set_title("2010 Season: Average Runs Per Game by Stadium", fontsize=12, fontweight='bold')
...
axes[0].annotate(f"COL: {col_2010_runs:.2f} runs/game", 
                ...
                arrowprops=dict(arrowstyle='->', color='darkorchid', lw=2, connectionstyle='arc3,rad=0.1'),fontsize=11, fontweight='bold', color='darkorchid',
                bbox=dict(boxstyle='round,pad=0.5', facecolor='white', edgecolor='darkorchid', alpha=0.8))

# 2021 visualization
bars_2021 = axes[1].barh(comparison_data_2021.home, comparison_data_2021.runs_2021, color=colors_2021)
axes[1].set_title("2021 Season: Average Runs Per Game by Stadium", fontsize=12, fontweight='bold')
